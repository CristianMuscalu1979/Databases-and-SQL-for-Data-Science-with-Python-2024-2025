...
SELECT CONCAT(nume, ' ', prenume) AS Nume_si_prenume FROM angajat;
...
SELECT nume, prenume,manager_id FROM angajat WHERE manager_id IS NULL;

SELECT nume, prenume,manager_id FROM angajat WHERE manager_id = 1;
